  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="ouvidoria.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="sugestoes.php" class="nav-link">
      ...
      <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Avalie nosso sistema!
        ...
        <strong>
          ...
          <a href="direitos.php" class="text-decoration-none">Gustavo B</a>.
        </strong>
